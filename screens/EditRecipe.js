...
const EditRecipe = ({ navigation, route }) => {
  ...
  const [recipeName, setRecipeName] = useState(route.params.name);
  const [showDummyImage, setShowDummyImage] = useState(image ? true : false);
  const [image, setImage] = useState(route.params.image);
  const [imageChanged, setImageChanged] = useState(false);

  const [cookTime, setCookTime] = useState(route.params.cookTime.toString());
  ...
  const [recipeTags, setRecipeTags] = useState(route.params.tags);
        ...
        <ScrollView>
          ...
          <View style={styles.inputContainer}>
            <TextInput
              ...
              mode="outlined"
              value={cookTime}
              onChangeText={(time) => setCookTime(time)}
              style={styles.input}
            />
            <TextInput
              label="Ingredients"
              ...
              right={
                <TextInput.Icon
                  icon="plus"
                  onPress={() => {
                    console.log("Add ingredient pressed!");
                    addIngredient();
                  }}
                  forceTextInputFocus={true}
                />
              }
              onChangeText={(ingredient) => setCurIngredient(ingredient)}
              style={styles.input}
            />
            ...
            <TextInput
              ...
              value={directions}
              multiline={true}
              onChangeText={(dir) => setDirections(dir)}
              style={styles.input}
            />
          </View>
        </ScrollView>
      ...
      <SafeAreaView style={styles.safeContainer}>
        <ScrollView contentContainerStyle={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(tag) => setCurTag(tag)}
          />
          <List.Section style={{ marginBottom: 10 }}>
